...
$(window).on("load", function () {
            ...
            function () {
                $(this)
                    .popover({
                        ...
                        content: "A powerful attack that does massive damage, does not get counter attacked, and does not use up a turn"
                    })
                    .popover("show");
            },
            function () {
            ...
            function () {
                $(this)
                    .popover({
                        ...
                        placement: "right",
                        title: "Attack:",
                        content: "Players attack power increases by it's base amount with each strike"
                    })
                    .popover("show");
            },
            function () {
    ...
    $("#specialBtn").click(function () {
        ...
        // Player damages enemy
        statusText.text(
            "You hit " + enemy.name + " for " + (player.AP + (player.AP * player.EXP) * 1.75) + " with a special attack."
        ); // Warning text
                ...
                setTimeout(function () {
                    ...
                    setTimeout(function () {
                        if (opponentsLeft === 0) {
                            ...
                            statusText.text(
                                "You defeated " + enemy.name + "! You are the god of the arena."
                            ); // Warning text
                            win(); // Win Condition
                        }
                        enemy.divID.css("display", "none");
                        ...
                        statusText.text(
                            "You defeated " + enemy.name + "! Select your next opponent."
                        ); // Warning text
                        // Resets combat to allow player to select a new opponent
                        combat = false;
                    }, 3000);
